...
def load(args):
  ...
  pre_model= torch.load(args.pre_model, map_location=torch.device('cpu'))
  #model.load_state_dict(torch.load('bert.pt6'))
...
def main():
  ...
  parser.add_argument("--data_file",
                      default='./dependency_relation1.txt',
                      type=str,
                      required=False,
  ...
  parser.add_argument("--output_file",
                      default='./dependency_relation_rep1(lcqmc).json',
                      type=str,
                      required=False,
                      help="output file where the features will be written")
  parser.add_argument("--pre_model",
                      default="./bert_lcqmc.pt",
                      type=str,
                      help="pre_model files")
